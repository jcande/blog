...
<center>
![An OR gate implemented in DOOM]({static}/images/doom-OR.png)
</center>
...
<center>
![An AND gate implemented in DOOM]({static}/images/doom-AND.png)
</center>
...
<center>
![A NOT gate implemented in DOOM]({static}/images/doom-NOT.png)
</center>
...
<center>
![A traditional half-adder circuit]({static}/images/doom-half-adder-circuit.png)<br />
...
<center>
![A non-traditional half-adder circuit]({static}/images/doom-half-adder-map.png)
</center>
...
## Download
In case you want to play around with the map, you can download it [here]({static}/data/half-adder.zip). You'll likely want to open it in a doom level editor. I used [Doom Builder](http://doombuilder.com/) to make it.
